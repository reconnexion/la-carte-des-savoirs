...
const APP_LANG = (import.meta.env.VITE_APP_LANG as string) || 'fr';
...
/**
 * Language is fixed per deployment (via VITE_APP_LANG) -- there is no in-app language switcher.
 * `changeLocale` is still wired up (it's part of Refine's `I18nProvider` contract) but nothing
 * in this app calls it today.
 *
