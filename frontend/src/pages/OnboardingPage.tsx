...
import { Layout, Steps, Card, Select, Radio, Input, Button, List, Tag, Checkbox, Alert, Typography, Space, Result } from 'antd';
...
const AddressConsentStep = ({ onNext }: { onNext: () => void }) => {
  ...
  return (
    <Card>
      <Title level={4}>Partager votre position</Title>
      <Paragraph>
        Pour apparaître sur la carte, vos contacts doivent pouvoir voir votre adresse approximative. Cette adresse est
        celle renseignée dans votre <Text strong>gestionnaire de porte-données</Text> (le tableau de bord de votre
        Pod ActivityPods) — si vous ne l'avez pas encore renseignée, faites-le d'abord là-bas, puis revenez ici.
      </Paragraph>
